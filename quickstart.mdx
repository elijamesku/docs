...
<Steps>
  ...
  <Step title="Authorize with Github">
    ...
    <Tip>
      Kyrna does not need **_read-only_**_ access _for cost estimation and resource discovery. Deployment uses your local credentials.
    </Tip>
  </Step>
...
<CardGroup cols={3}>
  <Card title="Video Tutorials" icon="video" href="https://www.youtube.com/@kyrnaos">
    Watch step-by-step video guides
  </Card>
  <Card title="Join Discord" icon="discord" href="https://discord.com/invite/eJGzVHWJDA">
